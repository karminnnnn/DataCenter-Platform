...
ADD COLUMN `if_market` int(1) NULL DEFAULT 0 COMMENT '是否数据集市专用 0-否 1-是' AFTER `expire_duration`;

ALTER TABLE `srt_cloud`.`data_assets_resource_mount`
ADD COLUMN `status` int(1) NOT NULL DEFAULT 1 COMMENT '状态 1-有效 0-失效' AFTER `deleted`;

ALTER TABLE `srt_cloud`.`data_assets_resource_mount`
ADD COLUMN `check_log` varchar(300) NULL COMMENT '检测日志' AFTER `status`;

ALTER TABLE `srt_cloud`.`data_service_api_auth`
ADD COLUMN `start_time` datetime NULL COMMENT '开始时间（数据集市用）' AFTER `request_times`,
ADD COLUMN `end_time` datetime NULL COMMENT '结束时间（数据集市用）' AFTER `start_time`;
...
-- ----------------------------
-- Table structure for data_market_check_process
-- ----------------------------
DROP TABLE IF EXISTS `data_market_check_process`;
CREATE TABLE `data_market_check_process`  (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '主键id',
  `resource_apply_id` bigint(20) NOT NULL COMMENT '申请id',
  `reason` varchar(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NULL DEFAULT NULL COMMENT '申请理由',
  ...
  `status` int(1) NOT NULL DEFAULT 0 COMMENT '1-已通过 2-未通过',
  `check_note` varchar(300) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NULL DEFAULT NULL COMMENT '审核说明',
...
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_bin COMMENT = '数据集市-资源申请流程' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of data_market_check_process
-- ----------------------------

-- ----------------------------
-- Table structure for data_market_resource_apply
-- ----------------------------
DROP TABLE IF EXISTS `data_market_resource_apply`;
CREATE TABLE `data_market_resource_apply`  (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '主键id',
  `title` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NULL DEFAULT NULL COMMENT '标题',
  `resource_id` bigint(20) NOT NULL COMMENT '被申请的资源id',
  `resource_mount_id` bigint(20) NOT NULL COMMENT '被申请的挂载资源id',
  `mount_type` int(50) NULL DEFAULT NULL COMMENT '1-数据库表 2-api 3-文件',
  `mount_id` bigint(20) NULL DEFAULT NULL COMMENT '挂载的数据id（元数据，api，文件）',
  `app_id` bigint(20) NULL DEFAULT NULL COMMENT '应用id（私有api有此id）',
  `phone` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NULL DEFAULT NULL COMMENT '电话',
  `email` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NULL DEFAULT NULL COMMENT '邮箱',
  `apply_start_time` datetime(0) NULL DEFAULT NULL COMMENT '开始时间',
  `apply_end_time` datetime(0) NULL DEFAULT NULL COMMENT '结束时间',
  `apply_use_type` int(1) NULL DEFAULT NULL COMMENT '0-不限 1-指定',
  `apply_use_times` int(11) NULL DEFAULT NULL COMMENT '调用次数（api时有此值）',
  `apply_user_id` int(11) NULL DEFAULT NULL COMMENT '申请人id',
  `apply_note` varchar(300) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NULL DEFAULT NULL COMMENT '申请说明',
  `check_user_id` int(11) NULL DEFAULT NULL COMMENT '审核人id',
  `check_time` datetime(0) NULL DEFAULT NULL COMMENT '审核时间',
  `check_note` varchar(300) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NULL DEFAULT NULL COMMENT '审核说明',
  `status` int(1) NOT NULL DEFAULT 0 COMMENT '0-待审核 1-已通过 2-未通过',
  `if_auth` int(1) NOT NULL DEFAULT 0 COMMENT '是否已授权（0-否 1-是）',
  `project_id` bigint(20) NOT NULL COMMENT '项目id',
  `version` int(11) NULL DEFAULT NULL COMMENT '版本号',
  `deleted` tinyint(4) NULL DEFAULT NULL COMMENT '删除标识  0：正常   1：已删除',
  `creator` bigint(20) NULL DEFAULT NULL COMMENT '创建者',
  ...
  `update_time` datetime(0) NULL DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 6 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_bin COMMENT = '数据集市-资源申请表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of data_market_resource_apply
-- ----------------------------
INSERT INTO `data_market_resource_apply` VALUES (2, '私有 api 申请', 2, 29, 2, 5, 3, '12222', '2', '2023-08-01 12:00:00', '2023-08-31 12:00:00', 1, 5, 10000, '私有 api 申请', 10000, '2023-08-26 22:59:44', '通过', 1, 1, 10002, 5, 0, 10000, '2023-08-26 22:59:23', 10000, '2023-08-27 10:45:14');
INSERT INTO `data_market_resource_apply` VALUES (3, '私有 api 申请22', 2, 29, 2, 5, 3, '12222', '2', '2023-08-01 12:00:00', '2023-08-31 12:00:00', 1, 10, 10000, '私有 api 申请', 10000, '2023-08-26 23:08:51', '通过', 1, 1, 10002, 3, 0, 10000, '2023-08-26 23:08:34', 10000, '2023-08-27 10:45:12');
INSERT INTO `data_market_resource_apply` VALUES (4, '申请人口数据表', 2, 28, 1, 16, NULL, '333', '33', '2023-08-01 12:00:00', '2023-08-31 12:00:00', NULL, NULL, 10000, '申请人口数据表', 10000, '2023-08-27 10:39:39', '通过', 1, 1, 10002, 1, 0, 10000, '2023-08-27 10:39:09', 10000, '2023-08-27 10:39:39');
INSERT INTO `data_market_resource_apply` VALUES (5, '文件申请', 2, 10, 3, 1, NULL, '222', '222', '2023-08-01 12:00:00', '2023-08-31 12:00:00', NULL, NULL, 10000, '222', 10000, '2023-08-27 10:44:27', '通过', 1, 1, 10002, 1, 0, 10000, '2023-08-27 10:44:07', 10000, '2023-08-27 10:44:27');
INSERT INTO `data_market_resource_apply` VALUES (6, '测试APi', 2, 9, 2, 2, NULL, '2222', 'ddd', '2023-08-02 12:00:00', '2023-08-31 12:00:00', 0, NULL, 10000, '测试APi', 10000, '2023-08-28 11:29:29', '通过', 1, 1, 10002, 1, 0, 10000, '2023-08-28 11:29:19', 10000, '2023-08-28 11:29:29');

-- ----------------------------
-- Table structure for data_market_resource_comment
-- ----------------------------
DROP TABLE IF EXISTS `data_market_resource_comment`;
CREATE TABLE `data_market_resource_comment`  (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '主键id',
  `resource_id` bigint(20) NOT NULL COMMENT '资源id',
  `comment` varchar(300) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '评价',
  `level` int(1) NOT NULL DEFAULT 0 COMMENT '0-0星 1-1星 2-2星 3-3星 4-4星 5-5星',
  `project_id` bigint(20) NOT NULL COMMENT '项目id',
  `version` int(11) NULL DEFAULT NULL COMMENT '版本号',
  `deleted` tinyint(4) NULL DEFAULT NULL COMMENT '删除标识  0：正常   1：已删除',
  `creator` bigint(20) NULL DEFAULT NULL COMMENT '创建者',
  ...
  `update_time` datetime(0) NULL DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 3 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '数据集市-资源评价表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of data_market_resource_comment
-- ----------------------------
INSERT INTO `data_market_resource_comment` VALUES (1, 2, '测试评价', 2, 10002, 0, 0, 10000, '2023-08-27 10:27:55', 10000, '2023-08-27 10:27:55');
INSERT INTO `data_market_resource_comment` VALUES (2, 2, '非常满意啊啊   啊啊啊啊啊啊啊啊啊', 5, 10002, 0, 1, 10000, '2023-08-27 10:32:50', 10000, '2023-08-27 10:33:59');
...
) ENGINE = InnoDB AUTO_INCREMENT = 182 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '菜单管理' ROW_FORMAT = DYNAMIC;
...
) ENGINE = InnoDB AUTO_INCREMENT = 4 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '角色管理' ROW_FORMAT = DYNAMIC;
...
INSERT INTO `sys_role` VALUES (3, '测试项目角色', '测试项目角色', 0, NULL, 10002, 0, 0, 10000, '2022-11-25 20:10:26', 10000, '2023-07-23 13:59:02');
...
) ENGINE = InnoDB AUTO_INCREMENT = 188 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '角色菜单关系' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `sys_user`  (
  ...
  `update_time` datetime(0) NULL DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 10003 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '用户管理' ROW_FORMAT = DYNAMIC;
