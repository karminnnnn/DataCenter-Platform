-- 注意：如果 data_database 和 data_project 原来有数据，请建完字段后把 schema 字段信息补充完整
ALTER TABLE `srt_cloud`.`data_database`
ADD COLUMN `database_schema` varchar(200) NOT NULL COMMENT 'schema' AFTER `database_name`;

ALTER TABLE `srt_cloud`.`data_project`
ADD COLUMN `db_schema` varchar(50) NOT NULL COMMENT '数仓schema' AFTER `db_name`;

ALTER TABLE `srt_cloud`.`data_project`
ADD COLUMN `db_ip` varchar(50) NOT NULL COMMENT '数仓ip' AFTER `duty_person`,
ADD COLUMN `db_port` varchar(50) NOT NULL COMMENT '数仓端口' AFTER `db_ip`;

SET NAMES utf8mb4;
SET FOREIGN_KEY_CHECKS = 0;

-- ----------------------------
-- Table structure for data_governance_master_column
-- ----------------------------
DROP TABLE IF EXISTS `data_governance_master_column`;
CREATE TABLE `data_governance_master_column`  (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '主键id',
  `master_model_id` bigint(20) NOT NULL COMMENT '模型id',
  `name` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL COMMENT '字段名称',
  `comment` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NULL DEFAULT NULL COMMENT '注释',
  `field_type` int(2) NOT NULL COMMENT '数据类型',
  `field_length` int(2) NULL DEFAULT NULL COMMENT '长度',
  `sacle` int(2) NULL DEFAULT NULL COMMENT '小数位数',
  `nullable` int(1) NOT NULL DEFAULT 1 COMMENT '是否可为空 0-否 1-是',
  `pk` int(1) NOT NULL DEFAULT 0 COMMENT '主键 0-否 1-是',
...
) ENGINE = InnoDB AUTO_INCREMENT = 43 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_bin COMMENT = '数据治理-主数据模型字段' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Table structure for data_governance_master_data_catalog
-- ----------------------------
DROP TABLE IF EXISTS `data_governance_master_data_catalog`;
CREATE TABLE `data_governance_master_data_catalog`  (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '主键id',
  `parent_id` bigint(20) NOT NULL DEFAULT 0 COMMENT '父级id',
  `type` int(1) NOT NULL DEFAULT 0 COMMENT '类型-0-目录 1-主数据',
  ...
  `update_time` datetime(0) NULL DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 8 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_bin COMMENT = '数据治理-主数据目录' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Table structure for data_governance_master_distribute
-- ----------------------------
DROP TABLE IF EXISTS `data_governance_master_distribute`;
CREATE TABLE `data_governance_master_distribute`  (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '主键id',
  `master_model_id` bigint(20) NOT NULL COMMENT '主数据id',
  `name` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL COMMENT '派发名称',
  `distribute_type` int(1) NOT NULL COMMENT '派发类型 1-数据库 2-接口 3-消息队列',
  `distribute_json` text CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NULL COMMENT '派发json配置（不同类型json配置不同）',
  `incr_field` text CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NULL COMMENT '上次执行到的增量记录（预留字段）',
  `status` int(1) NOT NULL DEFAULT 0 COMMENT '状态 0-未发布 1-已发布',
  `task_type` int(1) NOT NULL DEFAULT 2 COMMENT '任务类型 2-一次性 3-周期性',
  `cron` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NULL DEFAULT NULL COMMENT 'cron表达式',
  ...
  `project_id` bigint(20) NOT NULL COMMENT '项目id（租户id）',
  `version` int(11) NULL DEFAULT NULL COMMENT '版本号',
  `deleted` tinyint(4) NULL DEFAULT NULL COMMENT '删除标识  0：正常   1：已删除',
  `creator` bigint(20) NULL DEFAULT NULL COMMENT '创建者',
  `create_time` datetime(0) NULL DEFAULT NULL COMMENT '创建时间',
  ...
  `update_time` datetime(0) NULL DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `master_model_id_idx`(`master_model_id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 8 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_bin COMMENT = '数据治理-主数据派发' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Table structure for data_governance_master_distribute_log
-- ----------------------------
DROP TABLE IF EXISTS `data_governance_master_distribute_log`;
CREATE TABLE `data_governance_master_distribute_log`  (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '主键id',
  `distribute_id` bigint(20) NOT NULL COMMENT '派发id',
  `master_model_id` bigint(20) NOT NULL COMMENT '主数据id',
  `run_status` int(1) NOT NULL COMMENT '运行状态（ 1-等待中 2-运行中 3-正常结束 4-异常结束）',
  `start_time` datetime(0) NOT NULL COMMENT '开始时间',
  `end_time` datetime(0) NULL DEFAULT NULL COMMENT '结束时间',
  `error_info` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NULL COMMENT '错误信息',
  `data_count` bigint(20) NULL DEFAULT 0 COMMENT '派发数据量',
  `byte_count` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NULL DEFAULT '0' COMMENT '数据量大小',
  `project_id` bigint(20) NOT NULL COMMENT '项目id（租户id）',
  `version` int(11) NULL DEFAULT NULL COMMENT '版本号',
  `deleted` tinyint(4) NULL DEFAULT NULL COMMENT '删除标识  0：正常   1：已删除',
  `creator` bigint(20) NULL DEFAULT NULL COMMENT '创建者',
  ...
  `update_time` datetime(0) NULL DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `distribute_id_idx`(`distribute_id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 21 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_bin COMMENT = '数据治理-主数据派发日志' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Table structure for data_governance_master_model
-- ----------------------------
DROP TABLE IF EXISTS `data_governance_master_model`;
CREATE TABLE `data_governance_master_model`  (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '主键id',
  `catalog_id` bigint(20) NOT NULL COMMENT '主数据目录id',
  `table_name` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL COMMENT '表名',
  `table_cn` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL COMMENT '中文名称',
  `description` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NULL DEFAULT NULL COMMENT '备注',
  `status` int(1) NOT NULL DEFAULT 0 COMMENT '发布状态 0-未发布 1-已发布',
  `release_time` datetime(0) NULL DEFAULT NULL COMMENT '发布时间',
  `release_user_id` bigint(20) NULL DEFAULT NULL COMMENT '发布人id',
  `project_id` bigint(20) NOT NULL COMMENT '项目id（租户id）',
  `version` int(11) NULL DEFAULT NULL COMMENT '版本号',
  ...
  INDEX `table_name_idx`(`table_name`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 4 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_bin COMMENT = '数据治理-主数据模型' ROW_FORMAT = Dynamic;
...
CREATE TABLE `sys_dict_data`  (
  ...
  `update_time` datetime(0) NULL DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 183 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '字典数据' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `sys_dict_type`  (
  ...
  `update_time` datetime(0) NULL DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 51 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '字典类型' ROW_FORMAT = DYNAMIC;
...
) ENGINE = InnoDB AUTO_INCREMENT = 186 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '菜单管理' ROW_FORMAT = DYNAMIC;
