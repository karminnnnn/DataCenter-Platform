CREATE TABLE `data_access_increase_log` (
  `id` bigint(11) NOT NULL AUTO_INCREMENT COMMENT '主键id',
  `data_access_id` bigint(11) NOT NULL COMMENT '数据接入id',
  `source_database_id` bigint(20) DEFAULT NULL COMMENT '源数据id',
  `target_database_id` bigint(11) DEFAULT NULL COMMENT '目的端数据库id（同步方式为2有此值）',
  `schema_name` varchar(200) COLLATE utf8mb4_general_ci NOT NULL COMMENT '模式名',
  `table_name` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '表名（sql）',
  `increase_column` varchar(200) COLLATE utf8mb4_general_ci NOT NULL COMMENT '增量字段',
  `start_val` varchar(200) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '开始值',
  `end_val` varchar(200) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '结束值',
  `access_mode` int(1) NOT NULL COMMENT '接入方式 1-接入ods 2-自定义接入',
...
) ENGINE=InnoDB AUTO_INCREMENT=10 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='数据集成-数据增量接入日志';

ALTER TABLE `srt_cloud`.`data_access_increase_log`
ADD INDEX `access_data_idx`(`data_access_id`, `source_database_id`);
...
CREATE TABLE `sys_dict_data`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 207 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '字典数据' ROW_FORMAT = DYNAMIC;
...
INSERT INTO `sys_dict_data` VALUES (203, 58, '统一映射', 'ALL', '', 1, 0, 0, 10000, '2024-01-16 09:45:47', 10000, '2024-01-16 09:45:47');
INSERT INTO `sys_dict_data` VALUES (204, 58, '单独映射', 'SINGLE', '', 2, 0, 0, 10000, '2024-01-16 09:46:29', 10000, '2024-01-16 09:46:33');
INSERT INTO `sys_dict_data` VALUES (205, 59, '主键排序比对', 'PK_ORDER_COMPARE', '', 1, 0, 0, 10000, '2024-01-16 16:09:17', 10000, '2024-01-16 16:09:17');
INSERT INTO `sys_dict_data` VALUES (206, 59, '增量字段', 'INCREASE_COLUMN', '', 2, 0, 0, 10000, '2024-01-16 16:09:30', 10000, '2024-01-16 16:09:30');
...
CREATE TABLE `sys_dict_type`  (
  ...
  `update_time` datetime(0) NULL DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 60 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '字典类型' ROW_FORMAT = DYNAMIC;
...
INSERT INTO `sys_dict_type` VALUES (58, 'mapper_type', '映射类型', '', 0, 0, 0, 10000, '2024-01-16 09:45:24', 10000, '2024-01-16 09:45:24');
INSERT INTO `sys_dict_type` VALUES (59, 'change_data_sync_type', '增量变更同步类型', '', 0, 0, 0, 10000, '2024-01-16 16:08:41', 10000, '2024-01-16 16:08:41');
