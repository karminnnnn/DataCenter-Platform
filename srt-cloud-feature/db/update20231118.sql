ALTER TABLE `srt_cloud`.`data_database`
ADD COLUMN `org_id` bigint(20) NULL COMMENT '单位id' AFTER `project_id`;
ALTER TABLE `srt_cloud`.`data_file`
ADD COLUMN `org_id` bigint(20) NULL COMMENT '机构id' AFTER `project_id`;
ALTER TABLE `srt_cloud`.`data_file_category`
ADD COLUMN `org_id` bigint(20) NULL COMMENT '机构id' AFTER `path`;
ALTER TABLE `srt_cloud`.`data_access`
ADD COLUMN `org_id` bigint(20) NULL COMMENT '机构id' AFTER `project_id`;
ALTER TABLE `srt_cloud`.`data_access_task`
ADD COLUMN `org_id` bigint(20) NULL COMMENT '机构id' AFTER `project_id`;
ALTER TABLE `srt_cloud`.`data_access_task_detail`
ADD COLUMN `org_id` bigint(20) NULL COMMENT '机构id' AFTER `project_id`;
ALTER TABLE `srt_cloud`.`data_access_task_detail`
ADD COLUMN `creator` bigint(20) NULL COMMENT '创建人（所有者）' AFTER `create_time`;
ALTER TABLE `srt_cloud`.`data_ods`
ADD COLUMN `layer` varchar(5) NOT NULL DEFAULT 'ODS' COMMENT '分层 ODS,DWD,DIM,DWS,ADS,OTHER' AFTER `data_access_id`,
ADD COLUMN `if_master` int(1) NOT NULL DEFAULT 0 COMMENT '是否主数据 0-否 1-是' AFTER `layer`;
RENAME TABLE data_ods to data_table;
ALTER TABLE `srt_cloud`.`data_production_catalogue`
ADD COLUMN `org_id` bigint(20) NULL COMMENT '机构id' AFTER `path`;
ALTER TABLE `srt_cloud`.`data_production_catalogue`
ADD COLUMN `task_sql_type` int(2) NULL COMMENT 'sql类型（作业类型为sql有此值）' AFTER `task_type`;
ALTER TABLE `srt_cloud`.`data_production_task`
ADD COLUMN `org_id` bigint(20) NULL COMMENT '机构id' AFTER `name`;
ALTER TABLE `srt_cloud`.`data_production_task_history`
ADD COLUMN `org_id` bigint(20) NULL COMMENT '机构id' AFTER `id`;
ALTER TABLE `srt_cloud`.`data_production_task_instance`
ADD COLUMN `org_id` bigint(20) NULL COMMENT '机构id' AFTER `name`;
ALTER TABLE `srt_cloud`.`data_production_task_instance_history`
ADD COLUMN `org_id` bigint(20) NULL COMMENT '机构id' AFTER `id`;
ALTER TABLE `srt_cloud`.`data_production_cluster`
ADD COLUMN `org_id` bigint(20) NULL COMMENT '机构id' AFTER `id`;
ALTER TABLE `srt_cloud`.`data_production_cluster_configuration`
ADD COLUMN `org_id` bigint(20) NULL COMMENT '机构id' AFTER `id`;
ALTER TABLE `srt_cloud`.`data_production_schedule`
ADD COLUMN `org_id` bigint(20) NULL COMMENT '机构id' AFTER `id`;
ALTER TABLE `srt_cloud`.`data_production_schedule_node`
ADD COLUMN `org_id` bigint(20) NULL COMMENT '机构id' AFTER `task_schedule_id`;
ALTER TABLE `srt_cloud`.`data_production_schedule_record`
ADD COLUMN `org_id` bigint(20) NULL COMMENT '机构id' AFTER `task_schedule_id`;
ALTER TABLE `srt_cloud`.`data_production_schedule_node_record`
ADD COLUMN `org_id` bigint(20) NULL COMMENT '机构id' AFTER `task_id`;
ALTER TABLE `srt_cloud`.`data_governance_metamodel`
ADD COLUMN `org_id` bigint(20) NULL COMMENT '机构id' AFTER `id`;
ALTER TABLE `srt_cloud`.`data_governance_metamodel`
MODIFY COLUMN `org_id` bigint(20) NULL DEFAULT 0 COMMENT '机构id' AFTER `id`;
ALTER TABLE `srt_cloud`.`data_governance_metadata_collect`
ADD COLUMN `org_id` bigint(20) NULL COMMENT '机构id' AFTER `release_time`;
ALTER TABLE `srt_cloud`.`data_governance_metadata_collect_record`
ADD COLUMN `org_id` bigint(20) NULL COMMENT '机构id' AFTER `end_time`;
ALTER TABLE `srt_cloud`.`data_governance_metadata`
ADD COLUMN `org_id` bigint(20) NULL COMMENT '机构id' AFTER `collect_task_id`;
ALTER TABLE `srt_cloud`.`data_governance_quality_config_category`
ADD COLUMN `org_id` bigint(20) NULL COMMENT '机构id' AFTER `note`;
ALTER TABLE `srt_cloud`.`data_governance_quality_config`
ADD COLUMN `org_id` bigint(20) NULL COMMENT '机构id' AFTER `note`;
ALTER TABLE `srt_cloud`.`data_governance_quality_task`
ADD COLUMN `org_id` bigint(20) NULL COMMENT '机构id' AFTER `error_log`;
ALTER TABLE `srt_cloud`.`data_governance_master_data_catalog`
ADD COLUMN `org_id` bigint(20) NULL COMMENT '机构id' AFTER `path`;
ALTER TABLE `srt_cloud`.`data_governance_master_model`
ADD COLUMN `org_id` bigint(20) NULL COMMENT '机构id' AFTER `release_user_id`;
ALTER TABLE `srt_cloud`.`data_governance_master_distribute`
ADD COLUMN `org_id` bigint(20) NULL COMMENT '机构id' AFTER `release_user_id`;
ALTER TABLE `srt_cloud`.`data_governance_master_distribute_log`
ADD COLUMN `org_id` bigint(20) NULL COMMENT '机构id' AFTER `byte_count`;
ALTER TABLE `srt_cloud`.`data_service_api_group`
ADD COLUMN `org_id` bigint(20) NULL COMMENT '机构id' AFTER `path`;
ALTER TABLE `srt_cloud`.`data_service_api_config`
ADD COLUMN `org_id` bigint(20) NULL COMMENT '机构id' AFTER `open_trans`;
ALTER TABLE `srt_cloud`.`data_service_app`
ADD COLUMN `org_id` bigint(20) NULL COMMENT '机构id' AFTER `if_market`;
ALTER TABLE `srt_cloud`.`data_service_api_log`
ADD COLUMN `org_id` bigint(20) NULL COMMENT '机构id' AFTER `error`;
ALTER TABLE `srt_cloud`.`data_assets_catalog`
ADD COLUMN `org_id` bigint(20) NULL COMMENT '机构id' AFTER `path`;
ALTER TABLE `srt_cloud`.`data_assets_resource`
ADD COLUMN `org_id` bigint(20) NULL COMMENT '机构id' AFTER `release_user_id`;

ALTER TABLE `srt_cloud`.`data_service_api_config`
ADD INDEX `group_id_idx`(`group_id`);

ALTER TABLE `srt_cloud`.`data_access`
ADD COLUMN `source_type` int(1) NOT NULL DEFAULT 1 COMMENT '1-指定表 2-自定义SQL' AFTER `org_id`;

ALTER TABLE `srt_cloud`.`data_access_task_detail`
MODIFY COLUMN `source_table_name` text NOT NULL COMMENT '源端表名' AFTER `source_schema_name`;

ALTER TABLE `srt_cloud`.`data_governance_quality_task_column`
ADD COLUMN `not_pass_reason` int(1) NULL COMMENT '1-空值 2-类型不匹配 3-长度 4-格式错误 5-不唯一' AFTER `check_row`;

update data_governance_quality_rule set deleted=1 where id IN (9,10)

ALTER TABLE `srt_cloud`.`data_access_task`
ADD COLUMN `run_type` int(1) NOT NULL DEFAULT 1 COMMENT '1-自动调度 2-手动触发' AFTER `org_id`,
ADD COLUMN `execute_no` varchar(40) NULL COMMENT '手动触发有此值' AFTER `run_type`;

ALTER TABLE `srt_cloud`.`data_governance_metadata`
MODIFY COLUMN `name` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '节点名称' AFTER `path`,
MODIFY COLUMN `code` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '节点英文名称' AFTER `name`;
...
) ENGINE = InnoDB AUTO_INCREMENT = 199 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '字典数据' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `sys_dict_type`  (
  ...
  `update_time` datetime(0) NULL DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 56 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '字典类型' ROW_FORMAT = DYNAMIC;
...
) ENGINE = InnoDB AUTO_INCREMENT = 191 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '菜单管理' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `data_production_jar` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '主键id',
  `project_id` bigint(20) NOT NULL DEFAULT '1' COMMENT '项目（租户id）',
  `org_id` bigint(20) DEFAULT NULL COMMENT '机构id',
  `name` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '名称',
  `submit_type` int(1) NOT NULL COMMENT '提交方式 1-standalone 4-yarn-application',
  `path` varchar(2000) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '文件地址',
  `main_class` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '主类',
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='数据生产-jar管理';
