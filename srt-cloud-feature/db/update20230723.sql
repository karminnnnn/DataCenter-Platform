...
-- ----------------------------
-- Table structure for data_assets_catalog
-- ----------------------------
DROP TABLE IF EXISTS `data_assets_catalog`;
CREATE TABLE `data_assets_catalog`  (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '主键id',
  `parent_id` bigint(20) NOT NULL DEFAULT 0 COMMENT '父级id',
  `type` int(1) NOT NULL DEFAULT 0 COMMENT '类型-0-文件夹 1-资产目录',
  `name` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL COMMENT '目录名称',
  `code` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL COMMENT '类目代码',
  `order_no` int(11) NULL DEFAULT 0 COMMENT '序号',
  `description` varchar(300) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NULL DEFAULT NULL COMMENT '描述',
  `path` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL COMMENT '目录全路径',
...
) ENGINE = InnoDB AUTO_INCREMENT = 4 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_bin COMMENT = '数据资产-资产目录' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of data_assets_catalog
-- ----------------------------
INSERT INTO `data_assets_catalog` VALUES (1, 0, 0, '测试1', 'test', 0, '', '测试1', 10002, 2, 0, 10000, '2023-07-05 09:03:51', 10000, '2023-07-05 09:06:43');
INSERT INTO `data_assets_catalog` VALUES (2, 1, 1, '资产目录', 'test-child', 0, '', '测试1/资产目录', 10002, 1, 0, 10000, '2023-07-05 10:37:17', 10000, '2023-07-05 10:41:44');
INSERT INTO `data_assets_catalog` VALUES (3, 1, 1, '测试目录2', 'test2', 1, '', '测试1/测试目录2', 10002, 0, 0, 10000, '2023-07-10 15:24:42', 10000, '2023-07-10 15:24:42');

-- ----------------------------
-- Table structure for data_assets_resource
-- ----------------------------
DROP TABLE IF EXISTS `data_assets_resource`;
CREATE TABLE `data_assets_resource`  (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '主键id',
  ...
  `summary` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NULL DEFAULT NULL COMMENT '摘要',
  `status` int(1) NOT NULL DEFAULT 0 COMMENT '0-未上架 1-已上架',
  `mount_status` int(1) NOT NULL DEFAULT 0 COMMENT '0-未挂载 1-已挂载',
  `open_type` int(1) NULL DEFAULT NULL COMMENT '1-全部 2-角色 3-用户',
  `open_roles` text CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NULL COMMENT '角色id列表（若开放范围为角色则有此字段）',
  `open_users` text CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NULL COMMENT '用户id列表（若开放范围为用户则有此字段）',
  `version_no` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL COMMENT '版本号',
  `duty_user` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NULL DEFAULT NULL COMMENT '负责人',
  `duty_phone` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NULL DEFAULT NULL COMMENT '负责人联系方式',
  `release_time` datetime(0) NULL DEFAULT NULL COMMENT '发布时间',
  `release_user_id` int(11) NULL DEFAULT NULL COMMENT '发布人id',
  ...
  `update_time` datetime(0) NULL DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `catalog_id_idx`(`catalog_id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 3 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_bin COMMENT = '数据资产-资产列表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of data_assets_resource
-- ----------------------------
INSERT INTO `data_assets_resource` VALUES (1, 2, '测试', 'test', '测试', 1, 0, 3, NULL, '[10001]', 'v1.0', 'admin', '', '2023-07-23 10:07:43', 10000, 10002, 14, 0, 10000, '2023-07-10 11:03:33', 10000, '2023-07-23 10:07:43');
INSERT INTO `data_assets_resource` VALUES (2, 2, '测试2', 'test2', '测试水水水水水', 1, 1, 2, '[3]', NULL, 'v1.0', 'admin', '', '2023-07-22 13:48:27', 10000, 10002, 17, 0, 10000, '2023-07-13 16:52:02', 10000, '2023-07-22 23:07:28');

-- ----------------------------
-- Table structure for data_assets_resource_mount
-- ----------------------------
DROP TABLE IF EXISTS `data_assets_resource_mount`;
CREATE TABLE `data_assets_resource_mount`  (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '主键id',
  `resource_id` bigint(20) NOT NULL COMMENT '资源id',
  `mount_type` int(1) NOT NULL COMMENT '1-数据库表 2-api 3-文件',
  `mount_id` bigint(20) NOT NULL COMMENT '挂载的数据id（元数据，api，文件）',
  `mount_name` varchar(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NULL DEFAULT NULL COMMENT '挂载的资源名称',
  `version` int(11) NULL DEFAULT NULL COMMENT '版本号',
  `deleted` tinyint(4) NULL DEFAULT NULL COMMENT '删除标识  0：正常   1：已删除',
  `project_id` bigint(20) NOT NULL COMMENT '项目（租户）id',
  `creator` bigint(20) NULL DEFAULT NULL COMMENT '创建者',
  `create_time` datetime(0) NULL DEFAULT NULL COMMENT '创建时间',
  `updater` bigint(20) NULL DEFAULT NULL COMMENT '更新者',
  `update_time` datetime(0) NULL DEFAULT NULL COMMENT '更新时间',
...
) ENGINE = InnoDB AUTO_INCREMENT = 27 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_bin COMMENT = '数据资产-资源挂载表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of data_assets_resource_mount
-- ----------------------------
INSERT INTO `data_assets_resource_mount` VALUES (8, 2, 1, 3, '测试采集目录/人口测试数据/人口信息表', 0, NULL, 10002, 10000, '2023-07-18 16:13:45', 10000, '2023-07-18 16:13:45');
INSERT INTO `data_assets_resource_mount` VALUES (9, 2, 2, 2, '测试目录/测试 API 目录/POST 请求测试', 0, NULL, 10002, 10000, '2023-07-18 16:14:04', 10000, '2023-07-18 16:36:45');
INSERT INTO `data_assets_resource_mount` VALUES (10, 2, 3, 1, '111/测试目录/测试文件目录/642fdd9f405aa93f862d70572d88ece.png', 0, NULL, 10002, 10000, '2023-07-18 16:14:37', 10000, '2023-07-18 16:14:37');
INSERT INTO `data_assets_resource_mount` VALUES (19, 2, 2, 4, '测试目录/测试 API 目录/PUT 测试', 0, NULL, 10002, 10000, '2023-07-21 17:32:31', 10000, '2023-07-21 17:32:31');
INSERT INTO `data_assets_resource_mount` VALUES (21, 2, 1, 31, '测试采集目录/测试项目<中台库>/dws_card_type_count', 0, NULL, 10002, 10000, '2023-07-22 10:15:50', 10000, '2023-07-22 10:15:50');
INSERT INTO `data_assets_resource_mount` VALUES (22, 2, 1, 34, '测试采集目录/测试项目<中台库>/人口信息表', 0, NULL, 10002, 10000, '2023-07-22 13:57:28', 10000, '2023-07-22 13:57:28');
INSERT INTO `data_assets_resource_mount` VALUES (27, 2, 2, 5, '测试目录/测试 API 目录/动态标签测试', 0, NULL, 10002, 10000, '2023-07-22 23:07:28', 10000, '2023-07-22 23:07:28');

-- ----------------------------
-- Table structure for data_assets_resource_open
-- ----------------------------
DROP TABLE IF EXISTS `data_assets_resource_open`;
CREATE TABLE `data_assets_resource_open`  (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '主键id',
  `resource_id` bigint(20) NOT NULL COMMENT '所属目录id',
  `open_type` int(1) NOT NULL COMMENT '2-角色 3-用户',
  `open_id` bigint(20) NOT NULL COMMENT '角色或用户id',
  `project_id` bigint(20) NOT NULL DEFAULT 1 COMMENT '项目id',
  `version` int(11) NULL DEFAULT NULL COMMENT '版本号',
  `deleted` tinyint(4) NULL DEFAULT NULL COMMENT '删除标识  0：正常   1：已删除',
  `creator` bigint(20) NULL DEFAULT NULL COMMENT '创建者',
  ...
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `resource_id_idx`(`resource_id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 3 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_bin COMMENT = '数据资产-资产开放关联表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of data_assets_resource_open
-- ----------------------------
INSERT INTO `data_assets_resource_open` VALUES (6, 1, 3, 10001, 10002, 0, NULL, 10000, '2023-07-22 22:53:32', 10000, '2023-07-22 22:53:32');
INSERT INTO `data_assets_resource_open` VALUES (7, 2, 2, 3, 10002, 0, NULL, 10000, '2023-07-22 22:53:41', 10000, '2023-07-22 22:53:41');
...
CREATE TABLE `sys_dict_data`  (
  ...
  `update_time` datetime(0) NULL DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 154 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '字典数据' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `sys_dict_type`  (
  ...
  `update_time` datetime(0) NULL DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 45 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '字典类型' ROW_FORMAT = DYNAMIC;
...
ALTER TABLE `srt_cloud`.`data_file_category`
ADD COLUMN `type` int(1) NULL DEFAULT 0 COMMENT '0-文件夹 1-文件目录' AFTER `parent_id`;
