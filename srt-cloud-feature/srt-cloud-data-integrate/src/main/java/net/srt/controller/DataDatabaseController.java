...
public class DataDatabaseController {
    ...
    public Result<PageResult<DataDatabaseVO>> page(@Valid DataDatabaseQuery query,@RequestHeader(value = "Authorization", required = false) String accessToken ) {
        PageResult<DataDatabaseVO> page = DataDatabaseService.page(query,accessToken);
    ...
    public Result<DataDatabaseVO> get(@PathVariable("id") Long id,@RequestHeader(value = "Authorization", required = false) String accessToken) {
